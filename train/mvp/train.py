...
def data_loader(batch):
    ...
    data_path = os.path.abspath(os.path.join(os.path.dirname(os.path.dirname(__file__)), '..', 'data')) + '\\features\\features_train_mvp.csv.gz'
...
def train(batch, epochs, hidden1, hidden2, lrate, dropout):
    ...
    torch.save(model, data_path + 'model_mvp.pth')

if __name__ == '__main__':
    train(32, 400, 32, 8, 0.00003, 0.3)
